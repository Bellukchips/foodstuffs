    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('banners.update',$data->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="input" placeholder="Title banner"
                    value="{{ $data->title ?? old('title') }}">
            </div>
            <div class="form-group">
                <label for="input">Image</label>
                <input name="img_banner" class="form-control" type="file" placeholder="Image Categorie">
            </div>
            <div class="form-group">
                <img src="{{ url('storage/' . $data->img_banner) }}" alt="" width="400" height="200">
            </div>
            <div class="form-group">
